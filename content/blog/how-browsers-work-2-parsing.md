...
![곰돌이 푸가 눈을 찌푸리고 있는 사진](/images/img-03.png)
_아직 우리의 브라우저는 이 상태이다. 문서를 받긴 했는데 뭔 소린지 못 알아본다는 소리다_
...
![DOM Trees of Web Pages](/images/img-04.png)
_Learning DOM Trees of Web Pages by Subpath Kernel and Detecting Fake e-Commerce Sites(2021)_
...
![script, script async, script defer 세 경우의 HTML 파싱·스크립트 다운로드·실행 구간 비교](/images/browser-async-vs-defer-growingwiththeweb.png)
_출처: Growing with the Web, "Everything you need to know about the script tag"(2014)_
...
![DOM과 유사하지만 시각 정보 대신 역할(role)·이름(name)·상태(state) 같은 의미 정보만 담은 접근성 트리 구조](/images/browser-aom-tree-webdev.png)
_출처: web.dev, "The Accessibility Tree"(2016)_
